...
def make_page1_png(
    ...
    ax1.plot(bb.index, bb["bb_u2"], color="tab:blue", linewidth=1.0, alpha=0.8, label="BB +2σ")
    ...
    ax1.plot(bb.index, bb["bb_l3"], color="tab:red", linewidth=0.9, linestyle="--", alpha=0.8, label="BB -3σ")
